...
% this file provides the way to draw square chart of PD values.
% the code reference html is http://www.matlabsky.com/thread-32849-1-1.html

%##########################################################################

function draw_PD_matrix()
...
text(xtick,y-0.005,xstr,...
    'fontsize',8,...
    'Interpreter','none',...
    'color','black',...
    'HorizontalAlignment','left');
text(x+0.15,ytick,ystr,...
    'Interpreter','none',...
    'fontsize',8,...
    'color','black',...
...
if rot<180
    th=text(b+0.5,repmat(c(1)-.1*(c(2)-c(1))-1.1,length(b),1),a,'HorizontalAlignment','right','fontsize',8,'rotation',rot);
else
