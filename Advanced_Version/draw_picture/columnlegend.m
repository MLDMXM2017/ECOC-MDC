...
% this file provides the way to change the size of legend

%##########################################################################



% function legend_test()
% subplot(211); 
% plot(bsxfun(@times, [0:9]',[1:10])); 
% columnlegend(2, cellstr(num2str([1:10]')), 'location','north'); 
% disp(cellstr(num2str([1:10]')))
% end
% 
